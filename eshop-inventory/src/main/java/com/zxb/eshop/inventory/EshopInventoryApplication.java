...
@ComponentScan
@MapperScan("com.zxb.eshop.inventory.mapper")
public class EshopInventoryApplication {
	...
	public JedisCluster JedisClusterFactory(){
		...
		jedisClusterNodes.add(new HostAndPort("192.168.95.137",7003));
		jedisClusterNodes.add(new HostAndPort("192.168.95.137",7004));
		jedisClusterNodes.add(new HostAndPort("192.168.95.138",7005));
